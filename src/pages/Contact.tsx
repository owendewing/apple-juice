  ...
  return (
    <div className="bg-white text-black min-h-screen">
      ...
      <div className="flex flex-col items-center px-4">
        ...
        >
          <h1 className=" text-3xl md:text-5xl font-secondary uppercase tracking-wide">
            Project Submission
          </h1>
          <p>
          ...
          <div className="text-sm text-gray-600 space-y-2 pt-6">
            ...
            <p>
              The following questions are for the purposes of determining how
              best AJWNI Entertainment may be able to assist any potential
            ...
            <p>
              This questionnaire is not an offer of partnership or a commitment
              by AJWNI Entertainment to any party. Please answer as best you
              can.
            </p>
          </div>
